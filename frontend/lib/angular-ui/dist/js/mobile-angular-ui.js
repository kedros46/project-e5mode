...
Just declare it as a dependency to your frontend unless you have already included one of its super-modules.
 ...
 * ## Usage
 *
 * Declare it as a dependency to your frontend unless you have already included some of its super-modules.
 *
 * ```
 ...
 *   <ng-view class="frontend-content"></ng-view>
 * </div>
 * ```
 *
 ...
 *
 * ``` javascript
 * frontend.controller('newCustomerController', function($scope, Store){
 *   $scope.customer = {};
...
Declare it as a dependency to your frontend unless you have already
...
(function () {
    ...
    * 
    * ``` js
    * frontend.directive('myDirective', function('bindOuterClick'){
    *   return {
...
(function() {
   ...
   * ## Usage
   * 
   * Declare it as a dependency to your frontend unless you have already included some
   ...
   * 
   * ``` js
   * frontend.controller('myController', function($scope, SharedState){
   ...
   * 
   * ``` js
   * frontend.controller('controller1', function($scope, SharedState){
   *   SharedState.initialize($scope, 'myId');
   * });
   * 
   * frontend.controller('controller2', function(SharedState){
 ...
 * #### Usage
 *
 * Use `ui-prevent-touchmove-defaults` directive on root element of your frontend:
 * 
 * ``` html
 * <body ng-frontend='myApp' ui-prevent-touchmove-defaults>
 *   <!-- ... -->
 * </body>
 * ```
 *
 ...
 * ``` html
 * <div class="frontend">
 *   <div class="navbar navbar-frontend navbar-absolute-top">
 *     <!-- ... -->
 *   </div>
 * 
 *   <div class="navbar navbar-frontend navbar-absolute-bottom">
 *     <!-- ... -->
 *   </div>
 * 
 *   <div class="frontend-body">
 ...
 * ```
 * 
 * As you can notice the base class is `.navbar-frontend` while the positioning is
 ...
 * 
 * `.navbar-frontend` is specifically designed to support this different type of
 ...
 * @description
 * 
 * One thing you'll always have to deal with approaching mobile web frontend development is scroll and `position:fixed` bugs.
 * 
...
<div class="sidebar sidebar-left">
  <div class="scrollable">
    <h1 class="scrollable-header frontend-name">My App</h1>
          ...
          link: function (scope, elem, attrs) {
            ...
            scope.$on('mobile-angular-ui.state.changed.' + stateName, function (e, active) {
              ...
              if (active) {
                ...
                $rootElement
                  .removeClass(activeClass);
                // Note: .removeClass(visibleClass) is called on 'mobile-angular-ui.frontend.transitionend'
              }
            });
            ...
            scope.$on('mobile-angular-ui.frontend.transitionend', function() {
    ...
    return {
      ...
      link: function(scope, element) {
        ...
        element.on('transitionend webkitTransitionEnd oTransitionEnd otransitionend', function() {
          $rootScope.$broadcast('mobile-angular-ui.frontend.transitionend');
        });          
